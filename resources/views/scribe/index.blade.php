...
<head>
    ...
    <title>Adhivasindo Fullstack API Documentation</title>
...
<div class="bash-example">
    ...
    --get "http://localhost/api/contents" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"search\": \"b\",
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="search"                data-endpoint="GETapi-contents"
               value="b"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               step="any"               name="page"                data-endpoint="GETapi-contents"
               value="22"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="per_page"                data-endpoint="GETapi-contents"
               value="7"
               data-component="body">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/contents/architecto" \
    --header "Content-Type: application/json" \
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/contents/architecto"
);
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="content"                data-endpoint="PUTapi-contents--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="image"                data-endpoint="PUTapi-contents--id-"
               value="n"
               data-component="body">
    <br>
